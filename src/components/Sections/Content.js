...
const ContentSection = (props) => {
  const {
    section: { section_id, background, image, title, content, actions },
    annotationPrefix,
  } = props;
  ...
  return (
    <section
      id={section_id}
      className={`block text-block bg-${background} outer`}
      ...
      <div className="inner">
        <div className="grid">
          ...
          <div className="cell block-content">
            {title && (
              <h2 className="block-title underline" {...toFieldPath('.title')}>
                {title}
              </h2>
            )}
